...
df = pd.read_csv('C:\\Users\\Kathe\\Desktop\\NYC_CitiBike2022\\3.3_Include_Trips.csv', index_col=0)

# Create a copy with fewer columns
df_1 = df.drop(columns=['member_casual', 'season', 'start_station_id', 'end_station_id', 'start_lat', 'value','month'])
...
st.makrdown("- Most popular stations")
st.makrdown("- Weather component and bike usage")
st.makrdown(" - Interactive map with aggregated bike trips")
st.makrdown(" - Recommendations")
st.makrdown(" - The dropdown menu on the left 'Aspect Selector' will take you to the different aspects of the analysis out team looked at")
